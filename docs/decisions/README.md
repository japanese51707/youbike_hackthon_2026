...
| [ADR-017](ADR-017-多視野預測與累積分位數.md) | 多視野預測(30/60/90/120分)+累積分位數 | accepted | prediction, api, core | 進訓練前審查F-04/F-05；直接多視野非遞迴、分位數對累積Δ訓練;horizon用分鐘定義(粒度落差解法);Prediction改horizons[]陣列(改api_contract,通知B/C) |
